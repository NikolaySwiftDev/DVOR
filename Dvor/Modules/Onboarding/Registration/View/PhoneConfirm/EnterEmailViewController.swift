...
//    private let passwordTF = AuthTextFieldView(placeholder: "enteremail.char".loc)
//    
//    private let descEmailLabel = UILabel(text: "auth.email".loc, font: .poppins(weight: .medium, size: .small))
//    private let descPasswodLabel = UILabel(text: "auth.password".loc, font: .poppins(weight: .medium, size: .small))
//    
//    private var email = ""
//    
//    //MARK: - Life cycle
